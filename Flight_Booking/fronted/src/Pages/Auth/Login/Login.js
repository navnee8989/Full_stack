      ...
      .then((response) => {
        ...
        if (response.data.token === '' && !response.data.length) {
          ...
          dispatch((dispatch, getState) => {
            const prevState = getState().flight.user;
            console.log('Previous State:', prevState); // just for debugging
            
            // Assuming we want to merge new user details with previous user details
            const newUserDetails = {
              ...prevState,
              ...response.data.user,
            };
  
            dispatch(setLoginDetails(newUserDetails));
          });
